 ...
 * 创建时间         2017/05/06 01:20
 * 创建者           zbie
 * 邮箱             hyxt2011@163.com
 * Github:         https://github.com/zbiext
 * 简书:           http://www.jianshu.com/
 * QQ&WX：         1677208059
 * 描述            支持显示角标的title,角标布局可自定义
 */
public class BadgePagerTitleView extends FrameLayout implements IMeasurablePagerTitleView {
    ...
    public BadgePagerTitleView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BadgePagerTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setXBadgeRule(BadgeRule XBadgeRule) {
        if (XBadgeRule != null) {
            BadgeAnchor anchor = XBadgeRule.getAnchor();
    ...
    public void setYBadgeRule(BadgeRule YBadgeRule) {
        if (YBadgeRule != null) {
            BadgeAnchor anchor = YBadgeRule.getAnchor();
