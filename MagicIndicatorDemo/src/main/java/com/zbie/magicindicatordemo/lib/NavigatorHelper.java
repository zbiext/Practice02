 ...
 * 创建时间         2017/05/06 01:33
 * 创建者           zbie
 * 邮箱             hyxt2011@163.com
 * Github:         https://github.com/zbiext
 * 简书:           http://www.jianshu.com/
 * QQ&WX：         1677208059
 * 描述            方便扩展IPagerNavigator的帮助类,
 *                 将ViewPager的3个回调方法转换成
 *                 onSelected、onDeselected、onEnter等回调,方便扩展
 */
public class NavigatorHelper {

    private int mCurrentIndex;// 当前指示器的索引
    private int mTotalCount;// indicator的总数
    ...
    private float   mLastPositionOffsetSum;// 滑动的偏移,精确到小数
    private int     mLastIndex;// 上次的索引
    private boolean mSkimOver;// 忽略位置
