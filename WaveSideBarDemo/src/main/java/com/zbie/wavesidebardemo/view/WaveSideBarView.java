package com.zbie.wavesidebardemo.view;
 ...
 * 项目名           Practice02
 * 包名             com.zbie.wavesidebardemo.view
 * 创建时间         2017/05/08 19:58
 * 创建者           zbie
 * 邮箱             hyxt2011@163.com
...
public class WaveSideBarView extends View {
                ...
                if (oldChoose != newChoose) {
                    if (newChoose >= 0 && newChoose < mLetters.size()) {
                        ...
                        if (mOnTouchLetterChangedListener != null) {
                            mOnTouchLetterChangedListener.onLetterChange(mLetters.get(newChoose));
                        }
                    }
                }
                invalidate();
    ...
    public void setOnTouchLetterChangedListener(OnTouchLetterChangedListener listener) {
        if (listener == null) {
            throw new IllegalArgumentException("OnTouchingLetterChangedListener is null!");
        } else {
